...
export const OWNER_ROUTES: RouteEntry[] = [
  ...
  {
    path: "/owner/sovereign-capabilities",
    title: "Sovereign Capabilities",
    description: "Capability portfolio maturity, coverage & gap analysis",
    titleKey: "route.sovereignCapabilities",
    descriptionKey: "routeDesc.sovereignCapabilities",
    icon: Shield,
    mode: "owner",
    group: "Knowledge Command",
    order: 14.5,
    sidebar: true,
    pageKey: "sovereign-capabilities",
  },
  {
  ...
  },
  {
    ...
    title: "Aquisição de Conhecimento",
    description: "Planejamento, execução e ROI de aquisição de conhecimento",
    titleKey: "route.knowledgeAcquisition",
    descriptionKey: "routeDesc.knowledgeAcquisition",
    icon: Search,
    mode: "owner",
    group: "Delivery & Operations",
    order: 34,
