...
const LEGACY_ERROR_PATTERNS: Array<{
  ...
  { pattern: /DEPLOY_ENGINE_ERROR|VERCEL_DEPLOY_FAILED|VERCEL_EXCEPTION/i, code: "DEPLOY_ENGINE_ERROR", title: "Deploy engine error", suggestion: "O motor de deploy encontrou um erro. Use o botão 'Re-deploy' para tentar novamente. Se o problema persistir, verifique os logs de build no Vercel.", docUrl: "https://vercel.com/docs/deployments/troubleshoot-a-build" },
