 ...
 * admin forms, and historical views across Sprints 107–110.
 */
...
import { ExternalLink, Plus, AlertTriangle, Shield, ArrowRight, Info, TrendingUp, TrendingDown, Activity } from "lucide-react";
...
export function CrossSprintLink({ label, route, context }: CrossLinkProps) {
  ...
  return (
    <Button
      variant="ghost"
      size="sm"
      className="gap-1 text-xs h-auto py-1 px-2 text-muted-foreground hover:text-foreground"
