...
export default function AuditLogs() {
  ...
  const stats = [
    ...
    { label: "Warnings", value: warningCount, icon: AlertTriangle, color: "text-warning" },
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Audit trails, session digests e monitoramento do sistema</p>
          </div>
          <Button
            variant="outline"
            size="sm"
