...
const translations = {
  "pt-BR": {
    ...
    "sysIntel.subtitle": "Insights derivados de dados reais — AxionOS analisa e apresenta o estado verdadeiro do seu sistema",
    "sysIntel.statusActive": "Inteligência do Sistema Ativa",
    "sysIntel.activeInsights": "insights derivados",
    "sysIntel.patternsLearned": "padrões no grafo",
    "sysIntel.dataSources": "fontes de dados ativas",
    "sysIntel.advisoryNote": "Esses insights são derivados de dados reais do seu sistema. Nenhum valor é inventado ou estimado sem evidência.",
    "sysIntel.noData": "Sem dados suficientes para gerar insights. Execute pipelines e ingira conhecimento para alimentar a inteligência do sistema.",
    ...
    "sysIntel.catKnowledge": "Conhecimento",
    "sysIntel.insight.knowledgeTitle": "Base de Conhecimento",
    "sysIntel.insight.qualityTitle": "Qualidade dos Outputs",
    "sysIntel.insight.learningTitle": "Sinais de Aprendizado",
    "sysIntel.insight.costTitle": "Rastreamento de Custo",
    "sysIntel.insight.deliveryTitle": "Progresso de Entrega",
    "sysIntel.insight.coverageTitle": "Cobertura de Domínios",
  ...
  "en-US": {
    ...
    "sysIntel.subtitle": "Insights derived from real data — AxionOS analyzes and presents the true state of your system",
    "sysIntel.statusActive": "System Intelligence Active",
    "sysIntel.activeInsights": "derived insights",
    "sysIntel.patternsLearned": "patterns in graph",
    "sysIntel.dataSources": "active data sources",
    "sysIntel.advisoryNote": "These insights are derived from real system data. No values are invented or estimated without evidence.",
    "sysIntel.noData": "Insufficient data to generate insights. Run pipelines and ingest knowledge to feed system intelligence.",
    ...
    "sysIntel.catKnowledge": "Knowledge",
    "sysIntel.insight.knowledgeTitle": "Knowledge Base",
    "sysIntel.insight.qualityTitle": "Output Quality",
    "sysIntel.insight.learningTitle": "Learning Signals",
    "sysIntel.insight.costTitle": "Cost Tracking",
    "sysIntel.insight.deliveryTitle": "Delivery Progress",
    "sysIntel.insight.coverageTitle": "Domain Coverage",
