/**
 * Sprint 98 — Institutional Decision Engine (Auth hardened Sprint 197)
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const authResult = await authenticateWithRateLimit(req, "decision-engine");
