...
| 2 | **Advanced Operator Surface** | Workspace for reviewing outcomes, inspecting evidence, and supervising system evolution |
...
| 4 | **User Product Surface** | The visible product interface where users move through the idea â†’ deploy journey |
...
AxionOS should be understood as a **governed cognitive-operational system**. It does not merely execute tasks â€” it perceives, evaluates, constrains, formalizes, orchestrates, and learns.
...
Policy / Governance       -- constrains
   â†“
Action Engine             -- formalizes (Axion-style XML)
   â†“
...
For full details, see **[ARCHITECTURE.md](ARCHITECTURE.md) â€” Section 4B: Operational Decision Chain**.
...
| Subsystem | Role |
|-----------|------|
| **Canon** | Validated institutional knowledge â€” patterns, strategies, rules, playbooks. The system's long-term memory. |
...
| **Executors** | Final execution layer â€” agents, humans, or external systems that perform the action. |
...
1. **Knowledge informs** â€” Canon and Pattern Library provide validated operational knowledge to all downstream layers
2. **Signals evaluate** â€” Metrics, Events, and Readiness transform system state into auditable signals
3. **Policy constrains** â€” Governance rules determine whether an action is permitted and under what execution mode
4. **Actions are formalized** â€” The Action Engine maps triggers to intents, applies policy, and creates action records
5. **Orchestration coordinates execution** â€” AgentOS selects agents, assembles context, injects knowledge, and dispatches tasks
6. **Execution returns evidence** â€” Executors produce results that are captured as execution evidence
7. **Evidence feeds learning** â€” Evidence is analyzed, patterns are extracted, and validated knowledge is promoted back into Canon
...
1. **UI-driven decision making** â€” The UI surfaces should display state, not drive operational decisions. Decisions must flow through the canonical chain.

2. **Agent improvisation without policy** â€” Agents must operate under governance constraints. Without policy evaluation, agents can produce unpredictable, ungoverned behavior.

3. **Knowledge layers executing actions** â€” Canon and Pattern Library exist to inform, not to act. If knowledge layers trigger actions directly, the system loses auditability and predictability.

4. **Governance being bypassed** â€” Every important action must pass through policy evaluation. Bypassing governance creates ungoverned state mutations that cannot be audited or rolled back.
...
- **Execution Pipeline Core** â€” Deterministic pipeline that converts product ideas into software artifacts
- **Operational Intelligence Engine** â€” Analyzes execution outcomes, detects patterns, and improves operational strategies
- **Learning Engine** â€” Transforms execution evidence into recommendations and bounded system improvements
- **Execution Governance Engine** â€” Ensures all structural changes follow governance rules and human approval
- **Platform Intelligence Engine** â€” Maintains system-level awareness and performance insights
- **Platform Self-Calibration Engine** â€” Maintains system stability and operational equilibrium
- **Execution Strategy Evolution Engine** â€” Explores and refines better strategies for software creation
...
- **advisory-first** â€” all intelligence outputs are recommendations
- **governance before autonomy** â€” human approval for structural change
- **rollback everywhere** â€” every change preserves rollback capability
- **bounded adaptation** â€” all learning within declared envelopes
- **human approval for structural change** â€” no autonomous architecture mutation
- **tenant isolation** â€” all data scoped by organization_id with RLS
- **no autonomous architecture mutation** â€” forbidden mutation families enforced
...
- **Sprints 1â€“146** represent the canonical development arc of the platform
...
1. Read **[README.md](README.md)** â€” platform thesis, canon boundaries, and invariants
2. Read **[ARCHITECTURE.md](ARCHITECTURE.md)** â€” structural architecture, layers, containers, data flow
3. Read **[GOVERNANCE.md](GOVERNANCE.md)** â€” Agent OS modules, contracts, and governance reference
4. Read **[diagrams/system-brain-map.md](diagrams/system-brain-map.md)** â€” canonical visual brain map
